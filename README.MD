...
<html lang="en">
  <head>
    ...
    <script>
      <script src="https://unpkg.com/@clickwithclark/broprint.js@latest/lib/UMD/index.js">
    </script>
    <script>
      alert(`Here is your unique fingerprint: 
      fingerprint.getCurrentBrowserFingerPrint().then(identity=>alert(identity))`);
    </script>
